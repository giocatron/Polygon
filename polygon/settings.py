...
ALLOWED_CLIENT_HOSTS = os.environ.get("ALLOWED_CLIENT_HOSTS", "localhost,127.0.0.1,nano-core.herokuapp.com,nano-admin.herokuapp.com,nano-store.herokuapp.com")
...
STATICFILES_DIRS = [
    ("images", os.path.join(PROJECT_ROOT, "polygon", "static", "images"))
]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    "polygon.site.context_processors.site",
]
...
SECRET_KEY = os.environ.get("SECRET_KEY", "dksjal;sdjfl;ksjdl;fjsdl;fj;ladskjf")
...
MIDDLEWARE = [
    ...
    "polygon.core.middleware.request_time",
    "polygon.core.middleware.discounts",
    "polygon.core.middleware.google_analytics",
    "polygon.core.middleware.country",
    "polygon.core.middleware.currency",
    "polygon.core.middleware.site",
    "polygon.core.middleware.plugins",
    "polygon.core.middleware.jwt_refresh_token_middleware",
]
...
if ENABLE_DEBUG_TOOLBAR:
    ...
    try:
        ...
        MIDDLEWARE.append("polygon.graphql.middleware.DebugToolbarMiddleware")
...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "polygon.core.logging.JsonFormatter",
    ...
    "loggers": {
        ...
        "polygon": {"level": "DEBUG", "propagate": True},
        "polygon.graphql.errors.handled": {
            "handlers": ["default"],
            "level": "ERROR",
            "propagate": False,
        },
...
TEST_RUNNER = "polygon.tests.runner.PytestTestRunner"


PLAYGROUND_ENABLED = get_bool_from_env("PLAYGROUND_ENABLED", True)

ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,nano-core.herokuapp.com,nano-admin.herokuapp.com,nano-store.herokuapp.com"))
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "polygon.core.storages.S3MediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
elif GS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "polygon.core.storages.GCSMediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
...
SEARCH_BACKEND = "polygon.search.backends.postgresql"

AUTHENTICATION_BACKENDS = [
    "polygon.core.auth_backend.JSONWebTokenBackend",
]
...
GRAPHENE = {
    ...
    "MIDDLEWARE": [
        "polygon.graphql.middleware.OpentracingGrapheneMiddleware",
        "polygon.graphql.middleware.JWTMiddleware",
        "polygon.graphql.middleware.app_middleware",
    ],
}

PLUGINS_MANAGER = "polygon.plugins.manager.PluginsManager"

PLUGINS = [
"polygon.plugins.avatax.plugin.AvataxPlugin",
"polygon.plugins.vatlayer.plugin.VatlayerPlugin",
    "polygon.plugins.webhook.plugin.WebhookPlugin",
    "polygon.payment.gateways.dummy.plugin.DummyGatewayPlugin",
    "polygon.payment.gateways.dummy_credit_card.plugin.DummyCreditCardGatewayPlugin",
    "polygon.payment.gateways.stripe.plugin.StripeGatewayPlugin",
    "polygon.payment.gateways.braintree.plugin.BraintreeGatewayPlugin",
    "polygon.payment.gateways.razorpay.plugin.RazorpayGatewayPlugin",
    "polygon.payment.gateways.adyen.plugin.AdyenGatewayPlugin",
    "polygon.plugins.invoicing.plugin.InvoicingPlugin",
]

# Plugin discovery
installed_plugins = pkg_resources.iter_entry_points("polygon.plugins")
