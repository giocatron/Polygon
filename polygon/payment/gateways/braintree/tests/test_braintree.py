...
def test_get_error_for_client(braintree_error, monkeypatch):
    ...
    monkeypatch.setattr("polygon.payment.gateways.braintree.ERROR_CODES_WHITELIST", {})
    assert get_error_for_client([error]) == DEFAULT_ERROR

    monkeypatch.setattr(
        "polygon.payment.gateways.braintree.ERROR_CODES_WHITELIST",
...
@patch("polygon.payment.gateways.braintree.get_braintree_gateway")
