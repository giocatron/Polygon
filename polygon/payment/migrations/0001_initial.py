            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                polygon.payment.TransactionError("incorrect_number"),
                                "incorrect_number",
                            ),
                            (
                                polygon.payment.TransactionError("invalid_number"),
                                "invalid_number",
                            ),
                            (
                                polygon.payment.TransactionError("incorrect_cvv"),
                                "incorrect_cvv",
                            ),
                            (
                                polygon.payment.TransactionError("invalid_cvv"),
                                "invalid_cvv",
                            ),
                            (
                                polygon.payment.TransactionError("incorrect_zip"),
                                "incorrect_zip",
                            ),
                            (
                                polygon.payment.TransactionError("incorrect_address"),
                                "incorrect_address",
                            ),
                            (
                                polygon.payment.TransactionError("invalid_expiry_date"),
                                "invalid_expiry_date",
                            ),
                            (polygon.payment.TransactionError("expired"), "expired"),
                            (
                                polygon.payment.TransactionError("processing_error"),
                                "processing_error",
                            ),
                            (polygon.payment.TransactionError("declined"), "declined"),
                        ],
                        max_length=256,
                        null=True,
                    ),
