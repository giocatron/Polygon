...
@patch("polygon.order.emails.send_fulfillment_confirmation.delay")
@patch("polygon.order.emails.send_payment_confirmation.delay")
...
@patch("polygon.order.actions.send_order_canceled_confirmation")
...
@patch("polygon.order.actions.send_order_refunded_confirmation")
...
@patch("polygon.order.actions.emails.send_fulfillment_confirmation")
@patch("polygon.order.utils.get_default_digital_content_settings")
