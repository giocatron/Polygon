...
@mock.patch("polygon.order.emails.send_templated_mail")
...
@mock.patch("polygon.order.emails.send_order_refunded.delay")
...
@mock.patch("polygon.order.emails.send_order_canceled.delay")
