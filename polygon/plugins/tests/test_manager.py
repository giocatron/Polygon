...
def test_get_plugins_manager():
    manager_path = "polygon.plugins.manager.PluginsManager"
    plugin_path = "polygon.plugins.tests.sample_plugins.PluginSample"
...
@pytest.mark.parametrize(
    ...
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "15.0")],
)
...
@pytest.mark.parametrize(
    ...
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "0.0")],
)
...
@pytest.mark.parametrize(
    "plugins, shipping_amount",
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "10.0")],
)
...
@pytest.mark.parametrize(
    "plugins, amount",
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "12.30")],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ["polygon.plugins.tests.sample_plugins.PluginSample"],
...
@pytest.mark.parametrize(
    "plugins, show_taxes",
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], True), ([], False)],
)
...
@pytest.mark.parametrize(
    "plugins, amount",
    [(["polygon.plugins.tests.sample_plugins.PluginSample"], "15.0"), ([], "0")],
)
...
def test_manager_get_plugin_configurations(plugin_configuration):
    plugins = [
        "polygon.plugins.tests.sample_plugins.PluginSample",
        "polygon.plugins.tests.sample_plugins.PluginInactive",
    ]
    manager = PluginsManager(plugins=plugins)
...
def test_manager_save_plugin_configuration(plugin_configuration):
    plugins = ["polygon.plugins.tests.sample_plugins.PluginSample"]
    manager = PluginsManager(plugins=plugins)
...
def test_plugin_add_new_configuration(
    ...
    manager = PluginsManager(
        plugins=["polygon.plugins.tests.sample_plugins.PluginInactive"]
    )
...
def test_manager_serve_list_of_payment_gateways():
    ...
    plugins = [
        "polygon.plugins.tests.sample_plugins.PluginSample",
        "polygon.plugins.tests.sample_plugins.ActivePaymentGateway",
        "polygon.plugins.tests.sample_plugins.InactivePaymentGateway",
    ]
    manager = PluginsManager(plugins=plugins)
...
def test_manager_serve_list_all_payment_gateways_specified_currency():
    ...
    plugins = [
        "polygon.plugins.tests.sample_plugins.ActivePaymentGateway",
        "polygon.plugins.tests.sample_plugins.InactivePaymentGateway",
        "polygon.plugins.tests.sample_plugins.ActiveDummyPaymentGateway",
    ]
    manager = PluginsManager(plugins=plugins)
    assert (
