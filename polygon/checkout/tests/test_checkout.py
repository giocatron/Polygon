...
def test_get_discount_for_checkout_value_voucher(
    ...
    monkeypatch.setattr(
        "polygon.checkout.utils.calculations.checkout_subtotal",
        lambda checkout, lines, discounts: subtotal,
    )
    monkeypatch.setattr(
        "polygon.discount.utils.calculations.checkout_subtotal",
        lambda checkout, lines, discounts: subtotal,
    )
...
@patch("polygon.discount.utils.validate_voucher")
...
def test_get_discount_for_checkout_specific_products_voucher_not_applicable(
    ...
    discounts = []
    monkeypatch.setattr(
        "polygon.checkout.utils.get_prices_of_discounted_specific_product",
        lambda checkout, discounts, product: [],
    )
    monkeypatch.setattr(
        "polygon.checkout.calculations.checkout_shipping_price",
...
def test_get_discount_for_checkout_shipping_voucher_all_countries(monkeypatch):
    ...
    monkeypatch.setattr(
        "polygon.checkout.utils.calculations.checkout_shipping_price",
