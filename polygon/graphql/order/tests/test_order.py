...
@patch("polygon.graphql.order.mutations.draft_orders.add_variant_to_draft_order")
...
@patch("polygon.graphql.order.mutations.draft_orders.update_order_prices")
...
@patch("polygon.graphql.order.mutations.orders.cancel_order")
@patch("polygon.graphql.order.mutations.orders.clean_order_cancel")
...
@patch("polygon.graphql.order.bulk_mutations.orders.cancel_order")
