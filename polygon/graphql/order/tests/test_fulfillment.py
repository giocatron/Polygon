...
@patch("polygon.graphql.order.mutations.fulfillments.create_fulfillments")
...
@patch("polygon.graphql.order.mutations.fulfillments.create_fulfillments", autospec=True)
...
@patch("polygon.order.emails.send_fulfillment_update.delay")
...
@patch("polygon.order.actions.send_fulfillment_confirmation_to_customer", autospec=True)
