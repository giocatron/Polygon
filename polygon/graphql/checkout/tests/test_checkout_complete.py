...
@patch("polygon.checkout.complete_checkout.gateway.refund")
...
@patch("polygon.checkout.complete_checkout.gateway.void")
...
@patch("polygon.checkout.complete_checkout.gateway.payment_refund_or_void")
...
@patch("polygon.checkout.complete_checkout._create_order")
