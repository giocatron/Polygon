...
def test_product_query_error_when_id_and_slug_provided(
    ...
    assert graphql_log_handler.messages == [
        "polygon.graphql.errors.handled[ERROR].GraphQLError"
    ]
...
def test_product_create_with_collections_webhook(
    ...
    monkeypatch.setattr(
        "polygon.plugins.manager.PluginsManager.product_created",
...
@patch("polygon.plugins.manager.PluginsManager.product_updated")
...
@patch("polygon.product.tasks.update_variants_names.delay")
...
@patch("polygon.product.tasks._update_variants_names")
