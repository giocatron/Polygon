...
class CustomerEvent(CountableDjangoObjectType):
    ...
    order = graphene.Field(
        "polygon.graphql.order.types.Order", description="The concerned order."
    )
    order_line = graphene.Field(
        "polygon.graphql.order.types.OrderLine", description="The concerned order line."
    )
...
class UserPermission(Permission):
    source_permission_groups = graphene.List(
        graphene.NonNull("polygon.graphql.account.types.Group"),
...
class User(CountableDjangoObjectType):
    ...
    gift_cards = PrefetchingConnectionField(
        "polygon.graphql.giftcard.types.GiftCard",
    ...
    orders = PrefetchingConnectionField(
        "polygon.graphql.order.types.Order", description="List of user's orders."
    )
    ...
    permission_groups = graphene.List(
        "polygon.graphql.account.types.Group",
    ...
    stored_payment_sources = graphene.List(
        "polygon.graphql.payment.types.PaymentSource",
