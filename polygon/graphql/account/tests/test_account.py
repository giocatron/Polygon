...
@patch("polygon.account.emails._send_account_confirmation_email")
...
@patch("polygon.account.emails._send_set_password_email")
...
@patch("polygon.account.emails._send_set_user_password_email_with_url.delay")
...
@patch("polygon.account.emails._send_delete_confirmation_email")
...
@freeze_time("2018-05-31 12:00:01")
@patch("polygon.account.emails._send_account_delete_confirmation_email_with_url.delay")
...
@patch(
    "polygon.graphql.account.utils.account_events.staff_user_deleted_a_customer_event"
)
...
@patch("polygon.account.emails._send_password_reset_email")
...
@freeze_time("2018-05-31 12:00:01")
@patch("polygon.graphql.account.mutations.base.match_orders_with_new_user")
...
def test_user_avatar_update_mutation(monkeypatch, staff_api_client, media_root):
    ...
    monkeypatch.setattr(
        (
            "polygon.graphql.account.mutations.staff."
